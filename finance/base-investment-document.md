...
*Pricing evolution (three phases):*
  ...
  - **Phase 3 — Outcome-Based Pricing (September 2026+):** Pricing anchored to labor replacement value rather than software benchmarks. A fully loaded SEO specialist costs $90–97K/year in the US ($72K salary + 25–35% benefits/payroll taxes), and agencies spend 50–60% of revenue on payroll. Berlin targets outcome-based pricing in the $800–$1,200/month range — a fraction of the $4,000+/month US hire (or $700+/month in India) it replaces, supported by quantified results from founding partner case studies. Customers compare Berlin to a headcount at $60K–$120K/year, not a tool at $200/month per seat — a pricing ceiling set by labor budgets (see Labor-Addressable Market above), not the tool/software market.
